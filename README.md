...
**Endpoint:** `https://mcp.ansvar.eu/law-ie/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add irish-law --transport http https://mcp.ansvar.eu/law-ie/mcp` |
...
```json
{
  "mcpServers": {
    "irish-law": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/law-ie/mcp"
    }
  }
}
```
