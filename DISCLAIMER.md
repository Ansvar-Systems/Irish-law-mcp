...
- **No Solicitor-Client Relationship**: Use of this Tool does not create a solicitor-client relationship
...
If you are a solicitor, barrister, legal researcher, or other legal professional:

- **Negligence Risk**: Relying on unverified information from this Tool in professional legal work may constitute professional negligence
...
- **Regulatory Rules**: Solicitors regulated by the **Law Society of Ireland** and barristers regulated by the **Bar of Ireland (The Bar Council of Ireland)** must comply with applicable professional conduct rules when using AI tools
- **Client Disclosure**: Consider whether professional ethics rules require disclosing AI tool use to clients
- **Law Society / Bar of Ireland Guidance**: Follow published guidance on responsible use of AI in legal practice
...
1. Checking the official source (irishstatutebook.ie — the Irish Statute Book, maintained by the Office of the Attorney General)
2. Cross-referencing with courts.ie for case law and judicial decisions
3. Verifying the provision is currently in force and has not been amended or repealed
4. Reading the full context of cited provisions
5. Consulting relevant case law and authoritative commentary for interpretation
6. Considering how EU law obligations and recent legal developments may affect the matter

## Data Authority and Limitations

### Source Authority

This Tool aggregates data from official Irish legal databases. However:

| Source Type | Authority Level | Use Case |
|------------|----------------|----------|
| **irishstatutebook.ie** | Authoritative | Statute text, statutory instruments (primary reference) |
| **courts.ie** | Authoritative for case law | Judgments, decisions |
| **EUR-Lex** | Authoritative for EU law | EU directives, regulations, transposed obligations |
...
- Westlaw Ireland, LexisNexis Ireland, Bloomsbury Professional Ireland
...
- Irish law changes continuously through Acts of the Oireachtas, statutory instruments, and court decisions
...
- Even "fresh" data may be outdated if recent amendments were published in Iris Oifigiúil (the official Irish government gazette)
...
- A provision marked "in force" may have been:
  ...
  - Subject to transitional provisions affecting its applicability
  - Affected by commencement orders not yet reflected in the database
...
1. **Complete case law** — Coverage of Supreme Court, Court of Appeal, High Court, and Circuit/District Court decisions is limited; do not rely solely on this for case law research
2. **Historical statute versions** — Limited availability of provision wording as it stood at a given date
3. **Legal commentary** — No editorial annotations, academic commentary, or practice guides
4. **Unpublished decisions** — Tribunal decisions and administrative rulings largely absent
5. **Full legislative history** — Limited coverage of Oireachtas debates, explanatory memoranda, and Law Reform Commission reports
6. **EU transposition** — Not all EU directives transposed into Irish law may be fully captured
...
- **EU Law Blind Spots**: Cannot fully assess EU law obligations or the compatibility of Irish law with EU requirements
...
- This includes but is not limited to:
  ...
  - Regulatory sanctions from the Law Society of Ireland, the Bar of Ireland, or other bodies
  - Reputational damage
...
2. **Official Verification**: Cross-check ALL results with official sources (irishstatutebook.ie, courts.ie)
3. **Commercial Databases**: Use professional legal databases (Westlaw Ireland, LexisNexis Ireland) for authoritative, annotated versions
...
This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/Irish-law-mcp) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/Irish-law-mcp/issues
...
- **ALWAYS VERIFY** all legal information with official sources (irishstatutebook.ie, courts.ie)
...
- **COMPLY** with Law Society of Ireland and Bar of Ireland professional ethics rules regarding AI tool use and client confidentiality
